...
from keel.models.survival.baselines import available_baselines, missing_baselines
...
def run_landmark(
    ...
    * ``cox_landmark`` -- Cox refitted at each landmark on the customers at risk
    ...
    """
    from keel.models.survival.baselines import CoxBaseline, KaplanMeierBaseline
...
def run_static_seeds(data: SurvivalData, seeds: int = 10) -> pd.DataFrame:
    ...
    `keel/benchmarks/small_n.py` where it is held fixed -- these datasets are single
