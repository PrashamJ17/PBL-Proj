...
from keel.core.schema import TABLES, Dataset
...
class FeatureStore:
    ...
    #: buys, and are used by `keel.experiments.leakage_penalty`.
    SAFE = "available_at"
    ...
    def __init__(self, dataset: Dataset, strict: bool = True, mode: str = SAFE):
        ...
        `keel.experiments.leakage_penalty`. Nothing in the production path may
