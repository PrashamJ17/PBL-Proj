...
from keel.report.render import _CHART_RC, CSS, THEME_TOGGLE, _svg
...
def render_dashboard(
    ...
    `reasons` comes from `keel.report.reasons.explain`. `ids` is optional and only
...
<body>
  ...
  <p class="sub">Generated by Keel. The randomised holdout that produced these estimates
