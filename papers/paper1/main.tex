...
\todo{Phase 4 is now built and evaluated. The gate this section set --- does the rule
beat both ranking and doing nothing on realised money --- is \emph{partially} met:
it beats ranking, and it does not beat doing nothing. The results below and in
Section~\ref{sec:limitations} say so.}
