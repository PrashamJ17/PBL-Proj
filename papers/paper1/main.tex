...
%
% STATUS: DRAFT. Sections 2-6 and 8 report experiments that are implemented,
% tested and reproducible from this repository. Section 7 specifies the
% hierarchical estimator and its abstention rule but reports NO results,
% because Phase 4 is not built. Every number below is regenerable -- see
% papers/paper1/README.md for the command that produces each table.
%
...
SMS promotion (Lenta, 687{,}029 customers) should fall \emph{between} advertising
...
customer-churn dataset (7{,}032 real subscription customers), excluding
