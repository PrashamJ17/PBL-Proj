...
Two subcommands, and the order is not optional:
    ...
    python -m retainiq.cli preflight --customers c.csv --subscriptions s.csv
    python -m retainiq.cli autopsy   --customers c.csv --subscriptions s.csv --name "Acme"
...
from retainiq.ingest.csv_ingest import IngestError, load
