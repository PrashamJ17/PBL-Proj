...
from retainiq.models.survival.discrete import SurvivalData
from retainiq.models.survival.metrics import _step_lookup, kaplan_meier
...
class DeepSurvBaseline(SurvivalBaseline):
    ...
    reason `retainiq/benchmarks/models.py` hand-rolls its uplift learners: the method is
